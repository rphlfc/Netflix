        ...
        NavigationView {
            ZStack(alignment: .top) {
                ...
                ScrollView(.vertical, showsIndicators: false, content: {
                    VStack {
                        FeaturedView(viewModel: viewModel)
                        
                        ThumbsView(viewModel: viewModel, title: "TV Shows", endpoint: "/trending/tv/day?api_key=\(Constants.apiKey)")
                            .padding(.top)
                        
                        ThumbsView(viewModel: viewModel, title: "Trending Now", endpoint: "/trending/movie/day?api_key=\(Constants.apiKey)")
                            .padding(.top)
